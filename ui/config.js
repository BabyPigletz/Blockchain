...
// Update CONTRACT_ADDRESS after deploying with: npx hardhat run scripts/deploy.js --network hela

const CONFIG = {

  CHAIN_ID: 666888,
  CHAIN_ID_HEX: "0xa2908",
  NETWORK_NAME: "HeLa Testnet",
  RPC_URL: "https://testnet-rpc.helachain.com",
  EXPLORER_URL: "https://testnet.helascan.io",
      ...
      "outputs": [
        {
          "components": [
            ...
            {
              "internalType": "enum FinFlowPayments.PaymentStatus",
              "name": "status",
              "type": "uint8"
            }
          ],
          "internalType": "struct FinFlowPayments.Payment",
          "name": "",
          "type": "tuple"
        }
      ],
